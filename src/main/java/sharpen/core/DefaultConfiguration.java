...
public class DefaultConfiguration extends Configuration {
    ...
    private void setUpCollectionMappings() {
        ...
        mapProperty("android.graphics.drawable.BitmapDrawable.isRecycled", "IsRecycled");
        mapProperty("android.view.View.getLayoutParams", "LayoutParameters");
        mapProperty("android.view.View.getHeight", "Height");
        mapProperty("android.view.View.getPaddingBottom", "PaddingBottom");
        mapProperty("android.view.View.getPaddingLeft", "PaddingLeft");
        mapProperty("android.view.View.getWidth", "Width");//GetPaddingRight
        mapProperty("android.view.View.getPaddingRight", "PaddingRight");//GetPaddingRight
        mapProperty("android.view.View.getPaddingTop", "PaddingTop");//GetPaddingRight
        mapProperty("android.app.Activity.getIntent", "Intent");
        mapProperty("android.app.Activity.Intent.getExtras", "Extras");
        mapProperty("android.app.ActivityManager.getMemoryClass", "MemoryClass");
        mapField("android.graphics.BitmapFactory.Options.outHeight", "OutHeight");
        mapField("android.graphics.BitmapFactory.Options.outWidth", "OutWidth");
        mapField("android.graphics.BitmapFactory.Options.inJustDecodeBounds", "InJustDecodeBounds");
        mapField("android.graphics.BitmapFactory.Options.inSampleSize", "InSampleSize");
        mapField("android.graphics.BitmapFactory.Options.inJustDecodeBounds", "InJustDecodeBounds");
        mapField("android.view.ViewGroup.LayoutParams.width", "Width");
        mapField("android.view.ViewGroup.LayoutParams.height", "Height");
        mapMethod("junit.framework.Assert.assertNotSame", "NUnit.Framework.Assert.AreNotSame");
    }
